<template>
    <div>
                ...
                <li v-for="item in cartList">
                  <div class="cart-tab-1">
                    ...
                    <div class="cart-item-pic">
                      <img  v-lazy="'/static/img/'+item.img" :title="item.name">
                    </div>
                  ...
                  <div class="cart-tab-5">
                    <div class="cart-item-opration">
                      <a href="javascript:;" class="item-edit-btn" @click="delCartConfirm(item.id)">
      ...
      <nav-modal :mdShow="modalConfirm" v-on:dxh="closeModal">
        <span slot="message">确定删除当前商品吗?</span>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" v-on:click="cartDel">确定</a>
