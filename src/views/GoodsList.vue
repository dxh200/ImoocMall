<template>
    <div>
      ...
      <div class="accessory-result-page accessory-page">
        <div class="container">
          <div class="filter-nav">
            ...
            <a href="javascript:;" class="price" @click="setSortFlat" v-bind:class="{'sort-up':!sortFlat}">Price <svg class="icon icon-arrow-short"><use xlink:href="#icon-arrow-short"></use></svg></a>
      ...
      <!-- 未登录提示 -->
      <nav-modal v-bind:mdShow="mdShow" v-on:dxh="closeModal">
        <p slot="message">请登陆后，加入购物车</p>
        <div slot="btnGroup">
      ...
      <!-- 加入购物车提示 -->
      <nav-modal v-bind:mdShow="mdShowCart" v-on:dxh="closeModal">
        <p slot="message">
